...
namespace MtC.Tools.Quadtree.Example.Step4NestedClass
{
    public class QuadtreeNestedClass<T>
    {
        ...
        QuadtreeNestedClass<T> _root;
        QuadtreeNestedClass<T> _parent;
        QuadtreeNestedClass<T> _upperRightChild;
        QuadtreeNestedClass<T> _lowerRightChild;
        QuadtreeNestedClass<T> _lowerLeftChild;
        QuadtreeNestedClass<T> _upperLeftChild;
