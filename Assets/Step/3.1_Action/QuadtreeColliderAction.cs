...
namespace MtC.Tools.Quadtree.Step.Action
{
    public class QuadtreeColliderAction : MonoBehaviour
    {
        ...
        QuadtreeLeafAction<GameObject> _leaf;
        ...
        {
            UpdateLeaf();
            QuadtreeObjectAction.SetLeaf(_leaf);
        }
        ...
        void DoCheckCollision()
        {
            ...
            GameObject[] colliderGameObjects = QuadtreeObjectAction.CheckCollision(_leaf);
        ...
        {
            QuadtreeObjectAction.RemoveLeaf(_leaf);
        }
