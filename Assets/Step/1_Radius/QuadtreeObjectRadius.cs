...
namespace MtC.Tools.Quadtree.Step.Radius
{
    public class QuadtreeObjectRadius : MonoBehaviour
    {
        ...
        static QuadtreeRadius<GameObject> _quadtree;

        private void Awake()
        {
            _quadtree = new QuadtreeRadius<GameObject>(_top, _right, _bottom, _left, _maxLeafsNumber, _minSideLength);
        }
        ...
        public static void RemoveLeaf(QuadtreeLeafRadius<GameObject> leaf)
        {
