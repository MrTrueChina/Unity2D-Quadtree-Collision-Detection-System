...
public class QuadtreeCanUpwardsCollider : MonoBehaviour
{
    ...
    QuadtreeCanUpwardsData<GameObject>.Leaf _leaf;


    private void Awake()
    {
        _transform = transform;
        _leaf = new QuadtreeCanUpwardsData<GameObject>.Leaf(gameObject, GetLeafPosition(), _radius);
    }
    ...
    {
        UpdateLeaf();
        QuadtreeCanUpwards.SetLeaf(_leaf);
    }
    ...
    void DoCheckCollision()
    {
        ...
        GameObject[] colliderGameObjects = QuadtreeCanUpwards.CheckCollision(_leaf);
    ...
    {
        QuadtreeCanUpwards.RemoveLeaf(_leaf);
    }
