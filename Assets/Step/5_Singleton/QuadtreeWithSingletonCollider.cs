...
public class QuadtreeWithSingletonCollider : MonoBehaviour
{
    public float radius
    {
        get { return _radius; }
    ...
    QuadtreeWithSingletonData<GameObject>.Leaf _leaf;
    ...
    {
        UpdateLeaf();
        QuadtreeWithSingleton.SetLeaf(_leaf);
    }
    ...
    void DoCheckCollision()
    {
        ...
        GameObject[] colliderGameObjects = QuadtreeWithSingleton.CheckCollision(_leaf);
    ...
    {
        QuadtreeWithSingleton.RemoveLeaf(_leaf);
    }
