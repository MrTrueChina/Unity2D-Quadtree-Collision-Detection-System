...
[RequireComponent(typeof(QuadtreeWithNestedClassCollider))]
public class QuadtreeWithNestedClassDetector : MonoBehaviour
{
    QuadtreeWithNestedClassCollider _quadTreeCollider;
    ...
    private void Awake()
    {
        _quadTreeCollider = GetComponent<QuadtreeWithNestedClassCollider>();
    }
